...
class FeedbackRouter(Router):
	@cache
	def ping(self) -> str:
		return f"{BaseURL.FEEDBACK}/ping"

	@cache
	def new_feedbacks_questions(self) -> str:
		return f"{BaseURL.FEEDBACK}/api/v1/new-feedbacks-questions"

	@cache
	def question_count_unanswered(self) -> str:
		return f"{BaseURL.FEEDBACK}/api/v1/questions/count-unanswered"

	@cache
	def question_count(self) -> str:
		return f"{BaseURL.FEEDBACK}/api/v1/questions/count"

	@cache
	def question_list(self) -> str:
		return f"{BaseURL.FEEDBACK}/api/v1/questions"
	...
	def question_get(self) -> str:
		return f"{BaseURL.FEEDBACK}/api/v1/question"

	@cache
	def feedback_count_unanswered(self) -> str:
		return f"{BaseURL.FEEDBACK}/api/v1/feedbacks/count-unanswered"

	@cache
	def feedback_count(self) -> str:
		return f"{BaseURL.FEEDBACK}/api/v1/feedbacks/count"

	@cache
	def feedback_list(self) -> str:
		return f"{BaseURL.FEEDBACK}/api/v1/feedbacks"

	@cache
	def feedback_supplier_valuations_get(self) -> str:
		return f"{BaseURL.FEEDBACK}/api/v1/supplier-valuations"

	@cache
	def feedback_text_report(self) -> str:
		return f"{BaseURL.FEEDBACK}/api/v1/feedbacks/actions"
	...
	def feedback_answer_add(self) -> str:
		return f"{BaseURL.FEEDBACK}/api/v1/feedbacks/answer"
	...
	def feedback_order_return(self) -> str:
		return f"{BaseURL.FEEDBACK}/api/v1/feedbacks/order/return"

	@cache
	def feedback_get(self) -> str:
		return f"{BaseURL.FEEDBACK}/api/v1/feedback"

	@cache
	def feedback_archived_list(self) -> str:
		return f"{BaseURL.FEEDBACK}/api/v1/feedbacks/archive"
